...
*Файл подготовлен для оценки роли Frontend; при необходимости приложи скриншоты Cursor (модель, MCP, история коммитов) к WORKFLOW.md или видео по требованиям курса.*
